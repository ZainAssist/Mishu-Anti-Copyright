...
from Zainu import Zainu as app
from config import *

# Constants
START_TEXT = """<b>🤖 ᴍɪsʜᴜ ᴀɴᴛɪ-ᴄᴏᴘʏʀɪɢʜᴛ ʙᴏᴛ🛡️</b>
...
async def start_command_handler(_, msg):
    ...
    await msg.reply_photo(
        photo="https://graph.org/file/55d2f97206971898d9a9f-fdbbad0c7b74198c76.jpg",
        caption=START_TEXT,
